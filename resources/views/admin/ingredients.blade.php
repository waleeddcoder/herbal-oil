                ...
                <div class="flex flex-col sm:flex-row gap-5 items-start">
                    ...
                    <div class="flex-1 grid grid-cols-1 sm:grid-cols-12 gap-3 items-center w-full">
                        ...
                        <div class="sm:col-span-1">
                            <input type="number" name="sort_order" value="{{ $ingredient->sort_order }}" class="block w-full h-10 px-3 bg-slate-50 border border-slate-200 rounded-lg text-sm text-center">
                        </div>
